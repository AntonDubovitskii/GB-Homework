...
def my_func(number: int, word: str, statement: bool):
    """
    Принимает число, строку и булево значение. Печатает строку, в которой содержится число во 2 степени, переданная в
    качестве аргумента строка в верхнем регистре и булево значение обратное переданному.
    Если это описание возможно прочитать, значит работает маскировка декоратора.
    """
    number ** 2
