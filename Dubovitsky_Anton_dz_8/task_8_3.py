...
def my_func(number: int, word: str, statement: bool):
    """
    Принимает число, строку и булево значение. Возвращает число во 2 степени, длину слова и булево значение обратное
    введенному. Если это описание возможно прочитать, значит работает маскировка декоратора.
    """
    number ** 2
