...
def sum_list_1(dataset: list) -> int:
    ...
    for item in my_list:
        ...
        #my_list. Если это значение делится на 7 без остатка - значит выполняется условие задания и значение\
...
def sum_list_2(dataset: list) -> int:
    ...
    #while берется каждый элемент списка my_list, к нему прибавляется 17 и записывается по соответствующему индексу\
